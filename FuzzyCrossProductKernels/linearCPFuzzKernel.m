...
%G=linearCPFuzzKernel( X,Z): kernel between fuzzy data X and Z. 
...
%                          X{i}. G is the kernel matrix given by the linear
%                          cross product kernel on fuzzy sets
%
%G=linearCPFuzzKernel( X,Z,option):  option = 0 vectorized form, fast for
%                          fuzzy sets of example IV. option = 1 non vectorized form, fast for fuzzy sets of example V
%
%G=linearCPFuzzKernel( X,Z,option,agregation): agregation='sum' uses sum
...
%              G=linearCPFuzzKernel( X,Z,0,'prod')
%
% Example IV
